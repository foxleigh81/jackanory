...
When the target is small the tooltip arrow will be centered.

<Canvas withToolbar sourceState="shown" of={Stories.SmallTarget} />

### Long Tooltip

The tooltip arrow is also centered when the target width is less than 80% of the tooltip width.

<Canvas withToolbar sourceState="shown" of={Stories.LongTooltip} />
